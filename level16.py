...
class LevelObjects():
    ...
    def loadObjects(self):
        ...
        levelObject=[5,1,0, m.getSurf("dozerred"), 1,1, "playerAIDummy", "opponent1"]
        levelObjects.append(levelObject)
        levelObject=[7,7,0, m.getSurf("dozerred"), 1,1, "playerAIDummy", "opponent2"]
        levelObjects.append(levelObject)
        return levelObjects
...
class Instructions():
    ...
    def loadInstructions(self):
        strInstr = "Move your dozer to the opponents, \n" 
